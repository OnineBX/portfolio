...
export const about = {
    subtitle:'I\'m Ryan',
    content: '<p>My career life is 100% driven by my enthusiasm for thinking and programing. Since 2010, I have worked as programer for some companies, from startup to big firms. The Internet boom offers me lots of unprecedented opportunities to access to diverse novel techniques. </p>For the first three years, I\'ve worked for a startup and complete some web-based application for petrochemical industry. After that, I started to serve some Internet-based companies to implement mobile apps. During this period, I not only gained experiences in technique, but also learn how to do well in teamwork and know what I\'m going to be.<p>In recent two years, I\'m strongly aware of the importance of front-end technology and quite interested in working towards becoming a React senior. In the following years, I also plan to connect all the experience \" points\" to be a better-rounded full-stack dev.</p> <b>ps: also a runner & two kids\' father~</b>',
